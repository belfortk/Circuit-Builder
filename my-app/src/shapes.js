...
function makeAndGate (s, x, y) {
	...
	andP.attr({fill: "#ff0000", "fill-opacity": 1, style: "opacity:1;"});
	var box = andP.getBBox();
	var andR = s.rect(box.x, box.y, box.width, box.height).attr({id: "box", visibility: "hidden", fill: "none", stroke: "#84ddff", "stroke-width": 10, "stroke-dasharray": "20,20"});
	var andT = s.text(0.543783, 73.968241, "AND").attr({style: "font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:50.79999924px;font-family:Orkney;-inkscape-font-specification:'Orkney, Bold';font-variant-ligatures:normal;font-variant-caps:normal;font-variant-numeric:normal;font-feature-settings:normal;text-align:start;writing-mode:lr-tb;text-anchor:start;fill:#ffffff;stroke-width:0.26458332", "pointer-events": "none"});
	var andG = s.group(andP, andR, andT);
	andG.attr({transform: "translate(" +  (x-13) + "," + (y-13) + ") scale(0.25)", cx: x, cy: y});
	return andG;
}

function makeNotGate(s, x, y) {
	...
	notP.attr({fill: "#ffff00", "Fill-opacity": 1, style: "fill-rule:nonzero;color-rendering:auto;image-rendering:auto;shape-rendering:auto;text-rendering:auto;enable-background:accumulate"});
	var box = notP.getBBox();
	var notR = s.rect(box.x, box.y, box.width, box.height).attr({id: "box", visibility: "hidden", fill: "none", stroke: "#84ddff", "stroke-width": 10, "stroke-dasharray": "20,20"});	
	var notT = s.text(72.35701, 44.160145, "NOT").attr({style: "font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:50.79999924px;font-family:Orkney;-inkscape-font-specification:'Orkney, Bold';font-variant-ligatures:normal;font-variant-caps:normal;font-variant-numeric:normal;font-feature-settings:normal;text-align:start;writing-mode:lr-tb;text-anchor:start;fill:#000000;stroke-width:0.26458332", "pointer-events": "none"});
	var notG = s.group(notP, notR, notT);
	notG.attr({transform: "translate(" +  (x-34) + "," + (y-6) + ") scale(0.25)", cx: x, cy: y});
	return notG;
}

function makeOrGate(s, x, y) {
	...
	orP.attr({fill: "#0000ff", "fill-opacity": 1, style: "fill-rule:nonzero;color-rendering:auto;image-rendering:auto;shape-rendering:auto;text-rendering:auto;enable-background:accumulate"});
	var box = orP.getBBox();
	var orR = s.rect(box.x, box.y, box.width, box.height).attr({id: "box", visibility: "hidden", fill: "none", stroke: "#84ddff", "stroke-width": 10, "stroke-dasharray": "20,20"});
	var orT = s.text(83.761383, 93.807991, "OR").attr({style: "font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:50.79999924px;font-family:Orkney;-inkscape-font-specification:'Orkney, Bold';font-variant-ligatures:normal;font-variant-caps:normal;font-variant-numeric:normal;font-feature-settings:normal;text-align:start;writing-mode:lr-tb;text-anchor:start;fill:#ffffff;fill-opacity:1;stroke-width:0.26458332", "pointer-events": "none"});
	var orG = s.group(orP, orR, orT);
	orG.attr({transform: "translate(" +  (x-27) + "," + (y-19) + ") scale(0.25)", cx: x, cy: y});
	return orG;
}

function makeInGate(s, x, y) {
	var inP = s.rect(0, 0, 137.58333, 177.64879, 10.757587);
	inP.attr({fill: "#000000", "fill-opacity": 1, style: "opacity:1;"});	
	var box = inP.getBBox();
	var inR = s.rect(box.x, box.y, box.width, box.height).attr({id: "box", visibility: "hidden", fill: "none", stroke: "#84ddff", "stroke-width": 10, "stroke-dasharray": "20,20"});	
	var inT = s.text(39.803436,106.451813, "IN").attr({style: "font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:50.79999924px;font-family:Orkney;-inkscape-font-specification:'Orkney, Bold';font-variant-ligatures:normal;font-variant-caps:normal;font-variant-numeric:normal;font-feature-settings:normal;text-align:start;writing-mode:lr-tb;text-anchor:start;fill:#ffffff;stroke-width:0.26458332", "pointer-events": "none"});
	var inG = s.group(inP, inR, inT);
	inG.attr({transform: "translate(" +  (x-17) + "," + (y-22) + ") scale(0.25)", cx: x, cy: y});
	return inG;
}

function makeOutGate(s, x, y) {
	var outP = s.rect(0, 0, 137.58333, 177.64879, 10.757587);
	outP.attr({fill: "#000000", "fill-opacity": 1, style: "opacity:1;"});
	var box = outP.getBBox();
	var outR = s.rect(box.x, box.y, box.width, box.height).attr({id: "box", visibility: "hidden", fill: "none", stroke: "#84ddff", "stroke-width": 10, "stroke-dasharray": "20,20"});	
	var outT = s.text(14.437648, 106.451813, "OUT").attr({style: "font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:50.79999924px;font-family:Orkney;-inkscape-font-specification:'Orkney, Bold';font-variant-ligatures:normal;font-variant-caps:normal;font-variant-numeric:normal;font-feature-settings:normal;text-align:start;writing-mode:lr-tb;text-anchor:start;fill:#ffffff;stroke-width:0.26458332", "pointer-events": "none"});
	var outG = s.group(outP, outR, outT);
